...
CREATE TABLE IF NOT EXISTS pcw_players (
  ...
  movement_from_x DECIMAL(10,6) NULL DEFAULT NULL,
  movement_from_y DECIMAL(10,6) NULL DEFAULT NULL,
  movement_to_x DECIMAL(10,6) NULL DEFAULT NULL,
  movement_to_y DECIMAL(10,6) NULL DEFAULT NULL,
  movement_started_at_ms BIGINT NULL DEFAULT NULL,
  movement_duration_ms INT NULL DEFAULT NULL,
  enabled TINYINT(1) NOT NULL DEFAULT 1,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
